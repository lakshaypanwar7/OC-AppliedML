...
- **Source 1**: Microplastics distribution on the beach sediment based on satellite remote sensing: A case study in Bali, Indonesia
  ...
  - **[Link](https://www.sciencedirect.com/science/article/pii/S0169772226000252)**
  ...
  - **Relation to the Project**: It validates that satellite-derived environmental variables can explain why plastics accumulate in specific areas, which is essential for our model to predict where to "look" for spectral anomalies.
...
- **Source 3**: Detection and removal of microplastics in wastewater: evolution and impact (U.S. EPA/NOAA Framework Reference)
  ...
  - **Relation to the Project**: This provides the "Validation Standard." It lists the exact laboratory "Ground Truth" methods that we will reference when explaining why the satellite-based spectral unmixing is a necessary, scalable alternative to slow lab work.
